...
namespace HarrisPharmacy.API.Controllers.FormsAPI
{
    ...
    public class RegisterFido2Controller : Controller
    {
        ...
        private readonly IFidoService _fido2Storage;
        private readonly UserManager<IdentityUser> _userManager;

        public RegisterFido2Controller(IConfiguration config, IFidoService fido2Storage, UserManager<IdentityUser> userManager)
        {
